                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @error('kondisi')
                                            is-invalid
                                        @enderror">
                                            <option selected value="" disabled>Pilih Kondisi Barang</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @error('kategori')
                                            is-invalid
                                        @enderror">
                                            <option selected disabled valued="">Pilih Kategori Barang</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @error('berat')
                                            is-invalid
                                        @enderror"
                                            placeholder="Masukan berat" value="{{ old('berat') }}">
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <select name="masa" id=""
                                            ...
                                            is-invalid
                                            @enderror">
                                            <option selected>Pilih Masa Barang</option>
