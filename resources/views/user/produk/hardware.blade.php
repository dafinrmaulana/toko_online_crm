...
@section('content-admin')
    ...
    <div class="container">
        <section class="container bg-primary rounded hero d-flex align-items-center">
            <div class="row">
                <div class="col-lg-6 hero-img">
                    <img src="{{ url('assets/img/hd.png') }}" class="img-fluid" alt="">
                </div>
                <div class="col-md-6 d-flex flex-column justify-content-center">
                    <h1 class="text-center text-light">Kami juga menyediakan perangkat komputer untuk anda</h1>
                </div>
            </div>
        </section>
                    ...
                    @foreach ($data as $row)
                        <div class="col col-md-3">
                            <a href="/view/{{ $row->id }}" style="text-decoration: none" class="text-dark">
                                <div class="card mt-4 shadow p-3 mb-5  rounded" style="width:18rem">
